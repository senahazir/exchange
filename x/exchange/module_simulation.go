...
import (
	...
	"exchange/testutil/sample"
	exchangesimulation "exchange/x/exchange/simulation"
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreatePool,
		exchangesimulation.SimulateMsgCreatePool(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgUpdatePool,
		exchangesimulation.SimulateMsgUpdatePool(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgDeletePool,
		exchangesimulation.SimulateMsgDeletePool(am.accountKeeper, am.bankKeeper, am.keeper),
	))
