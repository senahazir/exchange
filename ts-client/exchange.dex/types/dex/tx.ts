...
const baseMsgCreatePool: object = { creator: "", height: 0 };
...
const baseMsgUpdatePool: object = { creator: "", id: 0, height: 0 };
...
export class MsgClientImpl implements Msg {
  ...
  CreatePool(request: MsgCreatePool): Promise<MsgCreatePoolResponse> {
    ...
    const promise = this.rpc.request("exchange.dex.Msg", "CreatePool", data);
  ...
  UpdatePool(request: MsgUpdatePool): Promise<MsgUpdatePoolResponse> {
    ...
    const promise = this.rpc.request("exchange.dex.Msg", "UpdatePool", data);
    return promise.then((data) =>
  ...
  DeletePool(request: MsgDeletePool): Promise<MsgDeletePoolResponse> {
    ...
    const promise = this.rpc.request("exchange.dex.Msg", "DeletePool", data);
    return promise.then((data) =>
