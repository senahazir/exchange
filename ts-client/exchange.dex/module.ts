...
export { MsgCreatePool, MsgUpdatePool, MsgDeletePool };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgCreatePool({ value }: msgCreatePoolParams): EncodeObject {
			try {
				return { typeUrl: "/exchange.dex.MsgCreatePool", value: MsgCreatePool.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdatePool({ value }: msgUpdatePoolParams): EncodeObject {
			try {
				return { typeUrl: "/exchange.dex.MsgUpdatePool", value: MsgUpdatePool.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDeletePool({ value }: msgDeletePoolParams): EncodeObject {
			try {
				return { typeUrl: "/exchange.dex.MsgDeletePool", value: MsgDeletePool.fromPartial( value ) }  
			} catch (e: any) {
...
const Module = (test: IgniteClient) => {
	return {
		module: {
			ExchangeDex: new SDKModule(test)
		},
		registry: msgTypes
  }
}
